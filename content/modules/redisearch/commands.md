...
| [FT.CONFIG GET](https://redis.io/commands/ft.config-get/) |  <span title="Not supported"><nobr>&#x274c; Not supported</span> | <span title="Not supported"><nobr>&#x274c; Not supported</span> | <span title="Not supported"><nobr>&#x274c; Not supported</nobr></span> | Displays configuration options. |
...
2. <a name="table-note-2" style="display: block; height: 80px; margin-top: -80px;"></a>[Contact support](https://redis.com/company/support/) to request RediSearch configuration changes for Flexible or Annual Redis Enterprise Cloud subscriptions.