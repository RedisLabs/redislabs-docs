...
* **A new aggregator: time-weighted average**
  ...
  ![twa](https://github.com/RedisTimeSeries/RedisTimeSeries/blob/master/docs/docs/images/twa.png)
...
* **Gap filling: optionally interpolate or repeat last value for empty buckets**
  ...
  ![gapfilling](https://github.com/RedisTimeSeries/RedisTimeSeries/blob/master/docs/docs/images/GapFilling.png)
