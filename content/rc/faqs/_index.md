...
- [Active-Active]({{< relref "/rs/databases/active-active/" >}}) and [Replica Of]({{< relref "/rs/databases/import-export/replica-of/" >}}) Geo Distribution
- Integration with [modules]({{< relref "/modules/" >}})
- Encryption of [persistence data]({{< relref "/rs/databases/configure/database-persistence.md" >}})
- Redis Enterprise Cloud [REST API]({{< relref "/rc/api/" >}})
