...
1. Enter the maintenance window time frame details.
    ...
    {{<image filename="images/rc/subscriptions-set-maintenance-windows.png" alt="The set maintenance windows panel" >}}{{< /image >}}
