...
| **Advanced Capabilities** | Modules used by the database. Choose from [RedisSearch]({{< relref "/stack/redisearch" >}}), [RedisJSON]({{< relref "/stack/redisjson" >}}), [RedisTimeSeries]({{< relref "/stack/redistimeseries" >}}), [RedisBloom]({{< relref "/stack/redisbloom" >}}), or [RedisGraph]({{< relref "/stack/previous-features/graph" >}}). |
