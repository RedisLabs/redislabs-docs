...
| **Advanced Capabilities** | Modules used by the database. Choose from [Search and query]({{< relref "/stack/search" >}}), [JSON]({{< relref "/stack/json" >}}), [Time Series]({{< relref "/stack/timeseries" >}}), [Probabilistic]({{< relref "/stack/bloom" >}}), or [Graph]({{< relref "/stack/deprecated-features/graph" >}}). |
