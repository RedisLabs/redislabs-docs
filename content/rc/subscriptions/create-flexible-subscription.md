...
| **Advanced Capabilities** | Identifies modules used by the database. Choose from [RedisSearch]({{< relref "/modules/redisearch/_index.md" >}}), [RedisJSON]({{< relref "/modules/redisjson/_index.md" >}}), [RedisBloom]({{< relref "/modules/redisbloom/_index.md" >}}), or [RedisGraph]({{< relref "/modules/redisgraph/_index.md" >}}). |
