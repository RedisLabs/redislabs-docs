...
1.  The **General** tab summarizes the your subscription details, the cost estimate, and the payment method.
    ...
    **General details** include:
    ...
    | **Cloud account** | (_AWS only_) Descriptive name of the associated cloud account (Useful for organizations that manage [multiple accounts]({{<relref "/rc/cloud-accounts/">}})) |
