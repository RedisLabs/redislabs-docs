...
- Run Redis Software using a [Docker container]({{< relref "/rs/installing-upgrading/quickstarts/get-started-docker.md" >}}), which lets you skip the installation process
