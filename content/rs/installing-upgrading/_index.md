...
- [Add users]({{<relref "/rs/security/access-control/manage-users">}}) to the cluster with specific permissions.  To begin, start with [Authentication and authorization]({{< relref "/rs/security/admin-console-security/user-security" >}}).
