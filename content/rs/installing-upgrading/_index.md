...
- If you want to use Redis on Flash (RoF) for your databases, review the prerequisites, storage requirements, and [other considerations]({{< relref "/rs/databases/redis-on-flash" >}}) for Redis on Flash databases.
...
1. [Create]({{< relref "/rs/clusters/new-cluster-setup" >}})
    or [join]({{< relref "/rs/clusters/add-node" >}}) an existing Redis Enterprise Software cluster.
