...
The RLEC SCC definitions are only applied to the project namespace when you apply them to the namespace specific Service Account as described in the [OpenShift Getting Started Guide]({{< relref "/platforms/getting-started/getting-started-kubernetes-openshift.md#step-3-prepare-your-yaml-files" >}}).
