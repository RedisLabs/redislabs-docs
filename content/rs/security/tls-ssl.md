...
1. Optional: Redis Enterprise enforce client certificate expiration date validation by default. It can be disabled on the database level using rladmin tool.
    ```sh
