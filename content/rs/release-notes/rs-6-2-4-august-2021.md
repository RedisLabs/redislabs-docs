...
- [In v6.0.20]({{<relref "/rs/release-notes/rs-6-0-20-april-2021.md">}}), the SASL-based LDAP mechanism was deprecated in favor of a new [RBAC-based approach]({{<relref "/rs/security/access-control/ldap/">}}).  As of v.6.2.4, support for the older mechanism has been removed.
