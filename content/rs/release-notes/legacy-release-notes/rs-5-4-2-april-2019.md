...
Starting with RS 5.4.2 you can use [maintenance mode](https://docs.redis.com/latest/rs/clusters/recover/maintenance-mode) to handle this process simply and efficiently.
