...
The storage options for [periodic database backup]({{< relref "/rs/databases/import-export/database-backup.md" >}}), [data export]({{< relref "/rs/databases/import-export/exporting-data.md" >}}), and [data import]({{< relref "/rs/databases/import-export/importing-data.md" >}}) are extended to include:
