...
You can now fine tune the [TLS configuration]({{< relref "/rs/security/database-security/tls-ssl.md" >}}), and ease certificates management by excluding client authentication enforcement,
