...
RS 5.6.0 adds support for [Redis on Flash]({{< relref "/rs/databases/redis-on-flash/" >}}) (RoF) databases with [Redis Modules]({{< relref "/modules/_index.md" >}}). [RedisJSON]({{< relref "/modules/redisjson/_index.md" >}}) is the first module to be available to run on a Redis on Flash database.
...
- [RedisBloom](https://redislabs.com/redis-enterprise/redis-bloom/), version [2.2.1]({{< relref "/modules/release-notes/redisbloom-release-notes/redisbloom-2.2-release-notes.md" >}})
- [RedisGraph](https://redislabs.com/redis-enterprise/redis-graph/), version [2.0.10]({{< relref "/modules/release-notes/redisgraph-release-notes/redisgraph-2.0-release-notes.md" >}})
...
- [RediSearch](https://redislabs.com/redis-enterprise/redis-search/), version [1.6.11]({{< relref "/modules/release-notes/redisearch-release-notes/redisearch-1.6-release-notes.md" >}}) (updated)
- [RedisTimeSeries](https://redislabs.com/redis-enterprise/redis-time-series/), version [1.2.3]({{< relref "/modules/release-notes/redistimeseries-release-notes/redistimeseries-1.2-release-notes.md" >}})
