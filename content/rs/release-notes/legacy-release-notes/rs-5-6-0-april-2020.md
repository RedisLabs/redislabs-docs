...
- [RedisBloom](https://redislabs.com/redis-enterprise/redis-bloom/), version [2.2.1]({{< relref "/modules/release-notes/redisbloom/redisbloom-2.2-release-notes.md" >}})
- [RedisGraph](https://redislabs.com/redis-enterprise/redis-graph/), version [2.0.10]({{< relref "/modules/release-notes/redisgraph/redisgraph-2.0-release-notes.md" >}})
...
- [RediSearch](https://redislabs.com/redis-enterprise/redis-search/), version [1.6.11]({{< relref "/modules/release-notes/redisearch/redisearch-1.6-release-notes.md" >}}) (updated)
- [RedisTimeSeries](https://redislabs.com/redis-enterprise/redis-time-series/), version [1.2.3]({{< relref "/modules/release-notes/redistimeseries/redistimeseries-1.2-release-notes.md" >}})
