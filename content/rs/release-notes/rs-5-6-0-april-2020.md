...
After upgrading to RS 5.6.0, you must upgrade your Active-Active database's [featureset version]({{< relref "/rs/installing-upgrading/upgrading.md#upgrading-active-active-databases" >}}).
