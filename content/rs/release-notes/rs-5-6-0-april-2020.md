...
- Starting RS 5.6.0, you must upgrade your Active-Active database's [featureset version]({{< relref "/rs/installing-upgrading/upgrading/#upgrading-active-active-databases.md" >}}) to get latest Active-Active features.
...
After upgrading to RS 5.6.0, you must upgrade your Active-Active database's [featureset version]({{< relref "/rs/installing-upgrading/upgrading/#upgrading-active-active-databases.md" >}}).
...
For more info and examples, check out [upgrading Redis Modules documentation]({{< relref "/modules/upgrading-rs.md#upgrading-the-module-for-the-database" >}}) .
