...
You can configure [Active-Active](https://docs.redis.com/latest/rs/databases/replica-of/) databases to use the [OSS Cluster API](https://docs.redis.com/latest/rs/clusters/optimize/oss-cluster-api/) using the admin console.
