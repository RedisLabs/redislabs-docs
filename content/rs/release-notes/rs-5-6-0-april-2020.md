...
- Support of OpenStack Object Storage ("Swift") for [backup, import and export location](https://docs.redis.com/latest/rs/databases/import-export/importing-data/) will end on November 30, 2020.
...
For more information, check out the [HyperLogLog on Active-Active documentation]({{< relref "/rs/databases/active-active/data-types/developing-hll-active-active.md" >}}).
...
You can configure [Active-Active]({{<relref "/rs/databases/active-active/_index.md" >}}) and [Replica Of]({{< relref "/rs/administering/designing-production/active-passive.md" >}}) databases to use the [OSS Cluster API]({{< relref "/rs/concepts/data-access/oss-cluster-api.md" >}}) using the admin console.
...
To enhance the availability and the consistency of [Active-Active geo-distributed Redis](https://docs.redis.com/rs/databases/active-active/),
[Replica HA](https://docs.redis.com/rs/administering/database-operations/replica-ha/) is enabled by default for all existing and new Active-Active Redis Databases.
