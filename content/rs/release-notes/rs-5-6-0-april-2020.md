...
- If you want to upgrade with ./install.sh -y , make sure that firewalld is running. If firewalld is not running, the upgrade succeeds but may have unexpected behavior.
