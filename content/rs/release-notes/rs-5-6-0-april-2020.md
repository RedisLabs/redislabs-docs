...
- Support of OpenStack Object Storage ("Swift") for [backup, import and export location](https://docs.redis.com/latest/rs/administering/import-export/importing-data/) will end on November 30, 2020.
