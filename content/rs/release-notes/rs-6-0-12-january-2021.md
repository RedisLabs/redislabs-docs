...
- User accounts can have multiple passwords to allow for [password rotation]({{<relref "/rs/security/access-control/manage-passwords#user-password-rotation">}})
...
In this version, you can only configure multiple passwords [using the REST API]({{<relref "/rs/security/access-control/manage-passwords#user-password-rotation">}}).
