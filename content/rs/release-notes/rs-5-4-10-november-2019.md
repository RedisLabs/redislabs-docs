...
- When you use Google Chrome browser on macOS Catalina to connect to the RS web UI with a self-signed certificate generated after June 2019,
    ...
    Instructions for updating certificates can be found [here](https://docs.redislabs.com/staging/next/rs/administering/cluster-operations/updating-certificates/).
