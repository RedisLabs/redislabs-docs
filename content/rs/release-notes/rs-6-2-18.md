...
| RedHat Enterprise Linux (RHEL) 8<br/>Oracle Enterprise Linux (OL) 8 | `f61d0d8f0bb5ad90a470482d6575eb27` |
...
## Enhancements added in 6.2.18-70 (January release)

- Added a new script for generating self-signed certificates, for certificate renewal. See [Certificates]({{<relref "/rs/security/certificates/">}})
