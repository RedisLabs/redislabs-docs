...
The capability of indexing, query and full-text search of nested JSON documents are now also GA on Active-Active (achieved by the combination of RedisJSON with RediSearch).
...
Find out more about [`Active-Active with RedisJSON`]({{<relref "//modules/redisjson/active-active">}})
