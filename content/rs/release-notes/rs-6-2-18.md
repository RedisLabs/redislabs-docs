...
Index, query, and full-text search of nested JSON documents are now available on Active-Active  databases by using the combination of RedisJSON with RediSearch.
