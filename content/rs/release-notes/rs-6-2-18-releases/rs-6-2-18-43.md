...
- RS81463 A shard might crash when resharding an Active-Active database with Auto Tiering (RoF). Specifically, the shard will crash when volatile keys or Active-Active tombstone keys reside in Flash memory.
