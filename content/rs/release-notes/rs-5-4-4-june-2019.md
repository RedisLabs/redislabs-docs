...
-  When subscribing to a channel while loading an AOF (recovering process) in an Active-Active database, the subscriber will get previous old messages that are stored in the AOF file.
