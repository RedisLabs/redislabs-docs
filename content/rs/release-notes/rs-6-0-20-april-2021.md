...
-   Support for the [BITFIELD data type on Active-Active]({{<relref "/rs/databases/active-active/develop/strings-active-active.md">}})
    Redis databases.
...
Active-Active Redis databases. Please read more about [developing for Active-Active with BITFIELD]({{<relref "/rs/databases/active-active/develop/strings-active-active.md">}})
