...
-   Support for the [BITFIELD data type on Active-Active]({{<relref "/rs/databases/active-active/data-types/strings-active-active.md">}})
    Redis databases.
...
(LDAP) authentication and authorization into its [role-based access controls]({{<relref "rs/security/passwords-users-roles.md##rolebased-access-control">}})
...
Active-Active Redis databases. Please read more about [developing for Active-Active with BITFIELD]({{<relref "/rs/databases/active-active/data-types/strings-active-active.md">}})
