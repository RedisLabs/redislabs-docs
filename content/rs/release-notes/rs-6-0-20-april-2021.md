...
-   RS61114 - Active-Active synchronization will fail in the following scenario - a new syncer connection is established AND a partial sync (psync) was initiated AND a cron job occurs before the first ACK of the psync was received.
