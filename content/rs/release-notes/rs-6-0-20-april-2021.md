...
-   The bundled RediSearch module was upgraded to v2.0.9
{{< warning >}}
This RediSearch version contains a major bug. More details on [RediSearch release notes](https://docs.redislabs.com/latest/modules/redisearch/release-notes/redisearch-2.0-release-notes/)).
We recommend not using it in production and retrograde to v2.0.8. An urgent fix will be released in v2.0.10.
{{< /warning >}}
