...
- Enhanced installation logs (RS69079, RS69571, RS77857, RS89760, RS99172, RS99173)

- Added support for `rladmin` envoy port configuration (RS72028, RS95483, RS97473)

- Support the option to avoid specific nodes when using optimized shards placement API  (RS98795)

- Check port availability before installation and upgrade (RS80815, RS99953)
