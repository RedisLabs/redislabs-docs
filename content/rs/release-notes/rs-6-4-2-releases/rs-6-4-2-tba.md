...
alwaysopen: false
categories: ["RS"]
aliases: /rs/release-notes/rs-6-4-2-releases/rs-6-4-2-tba/
---
...
8. <a name="table-note-8" style="display: block; height: 80px; margin-top: -80px;"></a>Redis Enterprise Software [6.4.2-tba]({{<relref "/rs/release-notes/rs-6-4-2-releases/rs-6-4-2-tba">}}) and later supports RHEL 8.8.

## Downloads

The following table shows the MD5 checksums for the available packages:

| Package | MD5 checksum (6.4.2-tba October release) |
|---------|---------------------------------------|
| Ubuntu 18 |  |
| Ubuntu 20 |  |
...
Redis Enterprise 6.4.2-tba supports open source Redis 6.2 and 6.0. Below is the list of open source Redis CVEs fixed by version.
