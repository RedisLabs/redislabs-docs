...
Follow these [instructions]({{< relref "/rs/installing-upgrading/upgrading.md" >}}) for upgrading to RS 5.4.14 from RS 5.0 and above.
...
- When you upgrade a cluster from version 5.0.2 to version 5.4.14, you must first upgrade to version 5.2.2 and then to version 5.4.14.
