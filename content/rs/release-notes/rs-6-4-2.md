...
If you are using custom installation with non-default $installdir and using A-A / RoF features, you might encounter failures during upgrade. The issue will be fixed in one of the next maintenance releases 
