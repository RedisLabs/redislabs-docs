...
- The following predefined roles and Redis ACLs are no longer available with new Redis Enterprise Software version 7.2.4 clusters. if they are not associated with any users or databases in the cluster:
...
- In the upcoming maintenance releases, the roles and ACLs will be automatically removed during the upgrade to Redis Enterprise Software version 7.2.4, unless they are associated with any users or databases in the cluster.
