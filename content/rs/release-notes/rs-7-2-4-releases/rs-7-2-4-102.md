---
Title: Redis Enterprise Software release notes 7.2.4-102 (February 2024)
linkTitle: 7.2.4-102 (February 2024)
...
Redis Enterprise Software versions 7.2.4-102 includes the following Redis Stack modules:
...
| Package | MD5 checksum (7.2.4-102 February release) |
|---------|---------------------------------------|
| Ubuntu 18 | dd8b6364990db28ffe05a4f8a7c2c7d5 |
| Ubuntu 20 | 6822d97db7d3a0b427a0533ec0c72686 |
| RedHat Enterprise Linux (RHEL) 7<br/>Oracle Enterprise Linux (OL) 7 | ba84b7b92c7068499d2ad99ed325495a |
| RedHat Enterprise Linux (RHEL) 8<br/>Oracle Enterprise Linux (OL) 8 <br/>Rocky Enterprise Linux | be67abbbabee5cd9395c71fcb77239d3 |
| Amazon Linux 2 | 954caebaf75d205010b1f705d1b1c71d |
...
Redis Enterprise 7.2.4-102 supports open source Redis 7.2, 6.2, and 6.0. Below is the list of open source Redis CVEs fixed by version.
