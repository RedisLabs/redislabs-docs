...
- The following predefined roles and ACLs ([deprecated in Redis Enterprise Software version 7.2.4-52](https://docs.redis.com/latest/rs/release-notes/rs-7-2-4-releases/rs-7-2-4-52/#access-control-deprecations)) are removed automatically when you upgrade the cluster, unless they are associated with any users or databases:
