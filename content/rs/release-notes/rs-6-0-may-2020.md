...
- [RedisBloom](https://redislabs.com/redis-enterprise/redis-bloom/), version [2.2.2]({{< relref "/modules/release-notes/redisbloom/redisbloom-2.2-release-notes.md" >}}) (updated)
- [RedisGraph](https://redislabs.com/redis-enterprise/redis-graph/), version [2.0.11]({{< relref "/modules/release-notes/redisgraph/redisgraph-2.0-release-notes.md" >}}) (updated)
...
- [RediSearch](https://redislabs.com/redis-enterprise/redis-search/), version [1.6.12]({{< relref "/modules/release-notes/redisearch/redisearch-1.6-release-notes.md" >}}) (updated)
- [RedisTimeSeries](https://redislabs.com/redis-enterprise/redis-time-series/), version [1.2.5]({{< relref "/modules/release-notes/redistimeseries/redistimeseries-1.2-release-notes.md" >}}) (updated)
