...
For more information, check out the [Redis Enterprise Software user management documentation]({{< relref "/rs/security/database-security/passwords-users-roles.md" >}}).
...
- Added REST API and rladmin commands to modify the timeout for [automatically disconnecting an inactive admin console session]({{< relref "/rs/security/database-security/passwords-users-roles.md" >}}).
