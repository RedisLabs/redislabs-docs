...
- Added REST API and rladmin commands to modify the timeout for [automatically disconnecting an inactive admin console session]({{<relref "/rs/security/access-control/manage-users#session-timeout">}}).
