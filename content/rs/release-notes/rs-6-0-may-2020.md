...
For more information, check out [Redis Streams on Active Active databases]({{< relref "/rs/databases/active-active/data-types/streams-active-active.md" >}}).
