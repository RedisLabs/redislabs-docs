...
| replication                                                                           | **true** <br> <br> false                        | Activates or deactivates [database replication]({{< relref "/rs/databases/configure/replication.md" >}}) where every master shard replicates to a replica shard                                                       |
| encryption                                                                            | true <br> <br> **false**                        | Activates or deactivates encryption                                                                                                                                                                                          |
| sharding                                                                              | true <br> <br> **false**                        | Activates or deactivates sharding (also known as [database clustering]({{< relref "/rs/databases/configure/replication.md" >}})) so that there is only one shard for the database                                     |
...
| oss-cluster                                                                           | true<br>**false**                               | Activates [OSS cluster API]({{< relref "/rs/clusters/optimize/oss-cluster-api" >}})                                                                                                                                |
...
| bigstore                                                                              | true <br> <br> **false**                        | If true, the database uses Redis on Flash to add flash memory to the database                                                                                                                                                |
