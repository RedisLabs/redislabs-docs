...
| saslauthd_ldap_conf | Updates LDAP authentication configuration for the cluster (see [Integrating LDAP Authentication]({{< relref "/rs/administering/designing-production/security/ldap-integration.md >}}) or [Kubernetes LDAP configuration]({{< relref "/platforms/kubernetes/tasks/ldap-on-k8s.md/#ldap-configuration >}})) |
