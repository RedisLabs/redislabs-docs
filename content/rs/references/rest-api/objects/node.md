...
| bigstore_driver | 'ibm-capi-ga1'<br />'ibm-capi-ga2'<br />'ibm-capi-ga4'<br />'speedb'<br />'rocksdb' | Bigstore driver name or none (deprecated, use the [cluster object]({{<relref "/rs/references/rest-api/objects/cluster">}})'s bigstore_driver instead) |
...
| public_addr | string | Public IP address of node (deprecated, use external_addr instead) |
