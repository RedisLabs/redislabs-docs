...
See [Install a module on a cluster]({{<relref "modules/install/add-module-to-cluster#rest-api-method">}}) for more info.
...
For modules in Redis Stack, download the module from the [Download Center](https://redis.com/redis-enterprise-software/download-center/modules/). See [Install a module on a cluster]({{relref "modules/install/add-module-to-cluster#rest-api-method"}}) for more info.
