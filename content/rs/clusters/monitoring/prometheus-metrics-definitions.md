...
| node_cert_expiration_seconds | Certificate expiration (returned number of seconds to expire) per given node; Read more about [certificates in Redis Enterprise]({{< relref "/rs/security/certificates" >}}) and about [monitoring certificates expiration]({{< relref "/rs/security/certificates/monitor_certificates" >}}) |
