...
1.  [Redis Enterprise pre-packaged modules - To download the upgrades
    ...
    1.  [[ReJSON]{style="font-weight: 400;"}](/redis-enterprise-documentation/developing/modules/rejson/)
    2.  [[RediSearch
        Enterprise]{style="font-weight: 400;"}](/redis-enterprise-documentation/developing/modules/redisearch/)
    3.  [[ReBloom]{style="font-weight: 400;"}](/redis-enterprise-documentation/developing/modules/bloom-filters/)
2.  [Custom packaged modules - For instructions on packing up any
    ...
    with
    Modules]{style="font-weight: 400;"}](/redis-enterprise-documentation/developing/modules/)[.]{style="font-weight: 400;"}
