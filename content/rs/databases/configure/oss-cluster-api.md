...
To verify that your database meets this requirement, make sure that the `CLUSTER KEYSLOT` reply is the same for all keys in the [multi-key command]({{< relref "/rs/databases/durability-ha/clustering#multikey-operations" >}}).
