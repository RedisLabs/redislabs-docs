...
To run an Active-Active database on installations from the [Redis Enterprise Software download package]({{< relref "rs/installing-upgrading/quickstarts/get-started-redis-enterprise-software.md" >}}),
