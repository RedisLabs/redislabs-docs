...
Redis databases that use [replication for high availability]({{< relref "/rs/databases/replication.md" >}}) maintain a replication backlog (per shard) to synchronize the primary and replica shards of a database.
