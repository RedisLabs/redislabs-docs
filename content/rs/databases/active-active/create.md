...
- [**Capabilities**]({{<relref "/stack">}}) - When you create a new in-memory database, you can enable multiple Redis modules in the database. For Auto Tiering databases, you can add modules that support Auto Tiering.
