...
1. Select **More Actions > Export**.

    {{<image filename="images/rs/database-more-actions-menu.png" alt="The more actions menu." >}}{{< /image >}}

    If the **Export** option is inactive, you do not have permission to export data.

1.  Select the [storage location](#supported-storage-locations) and enter the details for the import data file.
