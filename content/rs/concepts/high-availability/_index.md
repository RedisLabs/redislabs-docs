...
For more details, see [Replication]({{<relref "/rs/concepts/high-availability/replication.md">}}).
...
## [Rack-zone awareness]({{<relref "/rs/concepts/high-availability/rack-zone-awareness.md">}})
