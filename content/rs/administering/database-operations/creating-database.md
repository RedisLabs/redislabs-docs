...
1. Click **Next** to create a single-region Redis-on-RAM (RoR) database.
...
1. Select from the basic {{< field "db_type" >}} options:
    ...
    - [**Redis Modules**]({{< relref "/rs/developing/modules/_index.md" >}}) - When you create a new RoR or RoF database,
