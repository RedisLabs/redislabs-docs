...
1.  Edit and mark **SSL Authentication** for the source Database of the
    ...
    -   **SSL for All Communications **enforce SSL for both- application
        ...
        ![Replic-of
        Encryption](https://redislabs.com/images/rs/Screen-Shot-2018-03-29-at-10.17.59-PM.png){.wp-image-37193
    ...
    certificate](https://redislabs.com/images/rs/Screen-Shot-2018-03-29-at-10.32.01-PM.png){.size-full
...
1.  Edit the 'Replica of' section of the destination Database to point
    ...
    ![Replica-of
    Destination](https://redislabs.com/images/rs/Screen-Shot-2018-03-29-at-10.48.18-PM.png){.size-full
...
2.  From the *[source cluster]{.underline}*, copy the "Proxy
    ...
    Database:
    ![Replica-of Destination -
    Certificate](https://redislabs.com/images/rs/Screen-Shot-2018-03-29-at-10.49.55-PM.png){.size-full
