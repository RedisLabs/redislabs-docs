...
### Critical Bug Fix:
- Core:
  - When adding or removing a Redis Enterprise Software or Redis Enterprise Cloud database in RedsInsight v1 that has the RediSearch module loaded, all hashes within that database would be deleted.
...
- RediSearch:
  - Fixed bug where index info doesn't report right information for RediSearch v2.
- Profiling:
  - Added support for profiling MODULE commands.
  - Added support for viewing information of clients using ipv6 addresses.
- RedisGraph:
