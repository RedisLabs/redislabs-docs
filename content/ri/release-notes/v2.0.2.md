...
Enjoy a new Tree view available in Browser, which automatically groups keys scanned in your database into folders based on their namespaces. Now you can navigate through and analyze your list of keys quicker by opening only folders with namespaces you want.
...
- Added additional tutorials for Redis Stack database that describe a common use case through Redis capabilities
