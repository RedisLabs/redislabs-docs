...
RedisInsight-preview 2.0 can be installed along with the current GA (1.11) version with no issues.
...
- Data encryption:
  - Sensitive data such as connection certificates and passwords can optionally be encrypted 
