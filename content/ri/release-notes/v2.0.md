...
- [#548](https://github.com/RedisInsight/RedisInsight/pull/548), [#542](https://github.com/RedisInsight/RedisInsight/pull/542) Added SNI support - use host and port to connect to your Redis database and specify the server name under the TLS option
- [#521](https://github.com/RedisInsight/RedisInsight/pull/521/files) Added an option to save Profiler logs (should be enabled before starting the Profiler) into a .TXT file and download it to analyze outside of the application
- [#496](https://github.com/RedisInsight/RedisInsight/pull/496) Specify your own delimiters to work with keys in Tree view
- [#455](https://github.com/RedisInsight/RedisInsight/pull/455) Limited the movement of non-Redis editor to Workbench Editor area
- [#473](https://github.com/RedisInsight/RedisInsight/pull/473) Added a link to GitHub repository of RedisInsight
...
- [#586](https://github.com/RedisInsight/RedisInsight/pull/586) Added support for node grouping and pulsing
