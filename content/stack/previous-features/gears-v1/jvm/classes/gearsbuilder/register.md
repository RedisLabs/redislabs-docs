...
Registers the pipeline of functions to run when certain [events]({{<relref "/stack/previous-features/gears-v1/register-events">}}) occur. The registered functions will run each time the event occurs.
