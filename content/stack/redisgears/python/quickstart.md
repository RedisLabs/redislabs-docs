...
- Either:
    - A Redis Enterprise cluster with the [RedisGears module and Python plugin installed]({{<relref "/stack/redisgears/installing-redisgears#install-redisgears">}}) and [enabled on a database]({{<relref "/stack/redisgears/python/install">}})
