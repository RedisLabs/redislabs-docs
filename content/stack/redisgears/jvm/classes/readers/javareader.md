...
The implementation of the [`KeysOnlyReader`]({{<relref "/stack/redisgears/jvm/classes/readers/keysonlyreader">}}) class shows how to create a custom reader with `JavaReader`:
