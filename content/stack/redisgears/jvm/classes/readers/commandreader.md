...
1. Pass the `CommandReader` to the [`GearsBuilder.CreateGearsBuilder()`]({{<relref "/stack/redisgears/jvm/classes/gearsbuilder/creategearsbuilder">}}) function in your Java code.
