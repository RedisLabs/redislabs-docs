...
9. <a name="table-note-9" style="display: block; height: 80px; margin-top: -80px;"></a>Redis Enterprise Software [7.2.4-105]({{<relref "/rs/release-notes/rs-7-2-4-releases/rs-7-2-4-102">}}) and later supports RHEL 8.9.
