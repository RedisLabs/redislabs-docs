To encrypt Replica Of synchronization traffic, you must also [configure encryption for the destination database]({{< relref "/rs/databases/create-replica-of#configuring-tls-for-replica-of-traffic-on-the-destination-database" >}}).
