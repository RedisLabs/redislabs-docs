...
More info: [Ingress](https://kubernetes.io/docs/concepts/services-networking/ingress/), [Ingress routing for Redis Enterprise for Kubernetes]({{<relref "/kubernetes/networking/set-up-ingress-controller.md">}})
{{%/definition%}}
...
More info: [Redis on Flash]({{<relref "/rs/databases/redis-on-flash/">}}), [Redis on Flash (RoF) quick start]({{<relref "/rs/databases/redis-on-flash/rof-quickstart.md">}})
{{%/definition%}}
