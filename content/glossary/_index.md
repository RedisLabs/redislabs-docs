...
More info: [Redis on Flash]({{<relref "/rs/databases/redis-flash.md">}}), [Getting Started with Redis on Flash (RoF)]({{<relref "/rs/databases/getting-started-redis-flash.md">}})
{{%/definition%}}
