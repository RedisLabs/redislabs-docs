...
- You can [copy-and-paste]({{< relref  "/rv/api/how-to/using-curl#swagger-user-interface" >}}) the contents of the JSON file into the `POST /subscriptions` operation in the [Swagger UI](https://api.redislabs.com/v11.redislabs.com/beta1/swagger-ui.html).
