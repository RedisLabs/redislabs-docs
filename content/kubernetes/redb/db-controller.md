...
{{<note>}}
The steps below are only for connecting to your database from within your K8s cluster. To access your database from outside the K8s cluster, you need to configure [ingress]({{<relref "/platforms/kubernetes/redb/set-up-ingress-controller.md">}}) or use OpenShift routes.
{{</note>}}
