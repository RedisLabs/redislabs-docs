...
aliases: [
    ...
    /kubernetes/release-notes/k8s-6-2-18-41.md,
...
* **Services Rigger**: `redislabs/k8s-controller:6.2.18-41` or `redislabs/services-manager:6.2.18-40` (on the Red Hat registry)

## Bug fixes

* Fixed issues with corrupt image sha (OLM/OpenShift)(RED-88863)
* Fixed Active-Active upgrade issues wth NGINX (RED-88882)
...
* Fixed issues from running log collector on OLM (RED-90129
