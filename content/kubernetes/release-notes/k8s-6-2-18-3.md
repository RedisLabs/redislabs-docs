...
{{<warning>}}
If you use NGINX as an ingress controller, **do not upgrade** to this 6.2.18-3 release of Redis Enterprise for Kubernetes. We have been notified about a potential issue and are investigating. This issue does not impact new installs.
We will update this page and add more information when it is available. This note will remain until that point.
{{</warning>}}
