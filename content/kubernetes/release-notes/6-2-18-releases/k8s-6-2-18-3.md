...
* Support for [Auto Tiering]({{<relref "/kubernetes/re-clusters/redis-on-flash.md">}}) (RED-78613)
...
* `.isRoF` and `.rofRamSize` added to support the [Auto Tiering feature]({{<relref "/kubernetes/re-clusters/redis-on-flash.md">}}).
