...
The key features, bug fixes, and known limitations are described below.s
...
* **Supported upgrade paths**
  ...
  If you are using a versions earlier than 6.2.10-45, you cannot upgrade directly to this release. You must upgrade to 6.2.10-45 before you can upgrade to versions 6.2.18 or later.
