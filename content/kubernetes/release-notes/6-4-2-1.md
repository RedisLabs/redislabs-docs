---
Title: Redis Enterprise for Kubernetes release notes 6.4.2-1 (March 2023)
linktitle: 6.4.2-1 (March 2023)
description: 
weight: 57
alwaysopen: false
categories: ["Platforms"]
aliases: [ 
    /kubernetes/release-notes/k8s-6-4-2-1.md,
    /kubernetes/release-notes/k8s-6-4-2-1/,   ]
---
## Overview

The Redis Enterprise K8s 6.4.2-1 release supports the Redis Enterprise Software 6.4.2 and contains new features and feature improvements.
...
**OLM operator version**: `v6.4.2-1`

* **Redis Enterprise**: `registry.connect.redhat.com/redislabs/redis-enterprise:6.4.2-30.rhel8-openshift`
    (or `redislabs/redis-enterprise:6.4.2-30.rhel7-openshift` if upgrading from RHEL 7)
* **Operator**: `registry.connect.redhat.com/redislabs/redis-enterprise-operator:6.4.2-1`
* **Services Rigger**: `registry.connect.redhat.com/redislabs/services-manager:6.4.2-1`
