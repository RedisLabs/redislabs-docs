...
title: Redis Enterprise for Kubernetes release notes 7.2.4-7 (Sept 2023)
linkTitle: 7.2.4-7 (Sept 2023)
...
- **Redis Enterprise**: `registry.connect.redhat.com/redislabs/redis-enterprise:7.2.4-7.rhel8-openshift`
    (or `redislabs/redis-enterprise:7.2.4-7.rhel7-openshift` if upgrading from RHEL 7)
