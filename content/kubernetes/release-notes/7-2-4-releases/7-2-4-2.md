...
title: Redis Enterprise for Kubernetes release notes 7.2.4-8 (July 2023)
linkTitle: 7.2.4-8 (July 2023)
description: The Redis Enterprise K8s 7.2.4-8 release supports Redis Enterprise Software 7.2.4 and contains new features and feature improvements.
weight: 10
alwaysopen: false
