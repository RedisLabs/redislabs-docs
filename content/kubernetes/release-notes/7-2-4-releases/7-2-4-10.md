...
title: Redis Enterprise for Kubernetes 7.2.4-10 (Dec 2023) release notes 
linkTitle: 7.2.4-10 (Dec 2023)
...
- Added support for Redis Enterprise Software 7.2.4-86 (RED-113750)
...
The following changes included in this release affect the upgrade process. Please read carefully before upgrading to 7.2.4-10.

#### Upgrade operating system

{{<warning>}}If your databases use modules, you need to update all notes in the cluster to Redis Enterprise 7.2.4 or later before upgrading your operating system. See [Upgrade a cluster's operating system]({{<relref "/rs/installing-upgrading/upgrading/upgrade-os">}})in the Redis Enterprise Software documentation for more details.{{</warning>}}
...
| Azure AKS |  |  | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> |
| Google GKE | <span title="X icon">&#x274c;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> |
...
| **VMware TKGI version** | **1.14** | **1.15** | **1.16** | **1.17** |  |  |
|  | <span title="X icon">&#x274c;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> | <span title="Supported">&#x2705;</span> |  |  |

## Downloads

- **Redis Enterprise**: `redislabs/redis:7.2.4-86`
- **Operator**: `redislabs/operator:7.2.4-10`
- **Services Rigger**: `redislabs/k8s-controller:7.2.4-10.`

#### OpenShift images

- **Redis Enterprise**: `registry.connect.redhat.com/redislabs/redis-enterprise:7.2.4-86.rhel8-openshift`
    (or `redislabs/redis-enterprise:7.2.4-86.rhel7-openshift` if upgrading from RHEL 7)
- **Operator**: `registry.connect.redhat.com/redislabs/redis-enterprise-operator:7.2.4-10`
- **Services Rigger**: `registry.connect.redhat.com/redislabs/services-manager:7.2.4-10`

#### OLM bundle

**Redis Enterprise operator bundle** : `v7.2.4-10`
