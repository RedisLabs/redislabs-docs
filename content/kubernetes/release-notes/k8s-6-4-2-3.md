...
The Redis Enterprise K8s 6.4.2-3 release supports Redis Enterprise Software 6.4.2 and contains new features and feature improvements.
...
* **Operator**: `redislabs/operator:6.4.2-3`
* **Services Rigger**: `redislabs/k8s-controller:6.4.2-3`
...
* Redis Enterprise operator bundle version: `v6.4.2-3.0`

## Upgrade to 6.4.2-3

This release uses a new `ValidatingWebhookConfiguration` resource that replaces the old webhook resource. To use the 6.4.2-3 release, delete the old webhook resource and apply the new file.
