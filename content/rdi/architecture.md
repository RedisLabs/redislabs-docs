...
{{<image filename="/images/rdi/redis-di-simplified.png" alt="High-level Redis Data Integration architecture" >}}{{</image>}}
...
{{<image filename="/images/rdi/redis-di.png" alt="Detailed Redis Data Integration architecture" >}}{{</image>}}
