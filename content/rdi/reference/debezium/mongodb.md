...
debezium.source.mongodb.hosts=<REPLICATION_SET_NAME>/${SOURCE_DB_HOST}:${SOURCE_DB_PORT}
debezium.source.mongodb.connection.mode=replica_set
debezium.source.mongodb.user=${SOURCE_DB_USER}
debezium.source.mongodb.password=${SOURCE_DB_PASSWORD}
