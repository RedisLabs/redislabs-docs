...
# Uncomment the following line if you are using a separate user for Redis Data Integration.
#debezium.sink.redis.user=${RDI_REDIS_USER}
...
#javax.net.ssl.trustStore=${TRUST_STORE_FILE_PATH}
