...
```bash
wget https://qa-onprem.s3.amazonaws.com/redis-di/latest/redis-di-benchmark-ubuntu20.04-{{<param rdi_cli_preview>}}.tar.gz -O /tmp/redis-di-benchmark.tar.gz
```

### Ubuntu 18.04

```bash
wget https://qa-onprem.s3.amazonaws.com/redis-di/latest/redis-di-benchmark-ubuntu18.04-{{<param rdi_cli_preview>}}.tar.gz -O /tmp/redis-di-benchmark.tar.gz
```

### RHEL 8

```bash
wget https://qa-onprem.s3.amazonaws.com/redis-di/latest/redis-di-benchmark-rhel8-{{<param rdi_cli_preview>}}.tar.gz -O /tmp/redis-di-benchmark.tar.gz
```

### RHEL 7

```bash
wget https://qa-onprem.s3.amazonaws.com/redis-di/latest/redis-di-benchmark-rhel7-{{<param rdi_cli_preview>}}.tar.gz -O /tmp/redis-di-benchmark.tar.gz
```
