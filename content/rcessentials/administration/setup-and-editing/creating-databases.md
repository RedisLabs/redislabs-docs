...
1. Select your preferred [Data
    Persistence]({{< relref "/rc/concepts/data-persistence.md" >}})
    option.
1. If this is a **Pay-as-You-Go** subscription, you see [Database
    Clustering]({{< relref "/rc/concepts/clustering.md" >}})
    as an option.
...
1. If you would like periodic backups of your database, enter the path
    ...
    Database Backups for Redis Cloud Essentials]({{< relref "/rc/administration/configuration/backups.md" >}}).
