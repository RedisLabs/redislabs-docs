...
function setFeedbackMessage(kind, category, pageTitle) {
    if(kind === 1) {
        ...
        $('#page-feedback-open')
        .html('Thanks for your feedback! You can help improve the page by opening a GitHub <a style="text-decoration: underline;cursor:pointer;" href="https://github.com/RedisLabs/redislabs-docs/issues/new?assignees=&labels=&template=documentation-bug-report.md&title='+ category + ' - ' + pageTitle +'" target="_blank" rel="noopener noreferrer">issue</a>.');
    }
    setTimeout(function() {
        $('.page-feedback').hide();
    }, 5000);
