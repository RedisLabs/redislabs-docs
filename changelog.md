...
- Redis Enterprise Software doc updates: 
    ...
    - The cluster [maintenance mode](https://docs.redis.com/latest/rs/clusters/recover/maintenance-mode/) article has been updated ([PR #1647](https://github.com/RedisLabs/redislabs-docs/pull/1647))
