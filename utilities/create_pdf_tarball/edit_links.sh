...
sed 's^/">^">^g' tmp_index.html > ../../public/pdf-gen-modules-docs/index.html
...
sed 's^/">^">^g' tmp_index.html > ../../public/pdf-gen-platforms-docs/index.html
